...
const TITLE = "Claude Guest Pass: How to Get One | Claude Coupons";
const DESCRIPTION =
...
const URL = "https://claudecoupons.com/claude-guest-pass";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: DESCRIPTION,
    images: [
      { url: "/og.png", width: 1200, height: 630, alt: "Claude guest passes" },
    ],
  },
  twitter: {
...
const FACTS: { term: string; def: React.ReactNode }[] = [
  {
    term: "What it is",
  ...
  const schema = [
    {
      ...
      "@type": "Article",
      headline: "Claude guest pass: what it is and how to get one",
      description: DESCRIPTION,
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "FAQPage",
      mainEntity: GUEST_PASS_FAQS.map(({ q, a }) => ({
        "@type": "Question",
        name: q,
    ...
    <>
      ...
      <article className="mx-auto mt-8 max-w-3xl [&_h2]:mt-10 [&_h2]:mb-2.5 [&_h2]:text-[23px] [&_h2]:font-semibold [&_p]:mt-3">
        <h1 className="text-[28px] leading-tight font-bold sm:text-[34px]">
          Claude guest pass: what it is and how to get one
        </h1>

        {/* Answers the query inside the first forty words, then says the one thing no other
            page ranking for this term can say: you do not have to know a subscriber. */}
        <p className="text-[19px] text-muted">
          ...
          <strong>seven free days of the Pro plan</strong>, with Claude Code and
          Cowork included. It is not a coupon and there is no code to type - a
          pass is a link, and opening it starts the trial on claude.ai.
          Anthropic offers no other free trial of Claude Pro, which makes a
          guest pass the only official way to use the paid plan without paying
          for the first week.
        </p>
        <p className="text-[19px] text-muted">
        ...
        <p>
          <strong>&ldquo;Guest passes are Max-only.&rdquo;</strong> They are
          not. Anthropic&rsquo;s article says guest passes are &ldquo;currently
          available to eligible Pro and Max subscribers only&rdquo; - Pro
          counts. If you pay for Claude Pro, check{" "}
          ...
          <em>eligible</em>: being on Pro does not guarantee passes appear,
          which is probably where the Max-only claim came from.
        </p>
        <p>
          <strong>&ldquo;You get $10 for every referral.&rdquo;</strong> Widely
          repeated, nowhere in the documentation. What Anthropic actually says
          is that a guest pass &ldquo;sometimes&rdquo; results in &ldquo;a
          specified amount of overage credits&rdquo; - conditional,
          unquantified, and paid as usage credit rather than money. Those
          credits expire a year after they are issued and are voided if you drop
          to the Free tier. Share passes because an unused one expires
          worthless, not because you are counting on $10.
        </p>
        ...
        <ul className="mt-3 list-disc space-y-1 pl-6">
          ...
          <li>
            Pro-level usage limits and access to Anthropic&rsquo;s current
            models.
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          Anthropic&rsquo;s wording is that &ldquo;referral recipients must be
          new to Claude paid subscriptions&rdquo;, and that rules out anyone
          with a current Pro or Max plan and anyone who had one and canceled. A
          free claude.ai account is fine - that is not a paid subscription. If
          you are not eligible the link will open and the pass simply will not
          apply, so it is worth checking before you spend one.
        </p>

        <h2>The payment card, stated plainly</h2>
        <p>
          Redeeming a pass requires entering payment information. Anthropic does
          not charge it during the trial, and won&rsquo;t charge it at all if
          you cancel inside the seven days - but if you don&rsquo;t cancel, the
          trial &ldquo;will automatically convert to a paid Pro plan&rdquo;.
          That is the part the enthusiastic write-ups leave out, and a few of
          them claim outright that no card is needed. Set a reminder for day
          six.
        </p>

        <h2>Why a Claude guest pass link doesn&rsquo;t work</h2>
        <p>
          This is the most common complaint about the program, and it usually
          has a boring cause:
        </p>
        <ul className="mt-3 list-disc space-y-1 pl-6">
          <li>
            <strong>Someone got there first.</strong> Anthropic redeems passes
            first-come, first-served. A link posted anywhere public is often
            spent within minutes, and the link keeps working - it just stops
            granting anything.
          </li>
          <li>
          ...
          <li>
            <strong>A bug on the sender&rsquo;s account.</strong> Subscribers
            have reported links generating as invalid while passes still showed
            as remaining, and passes vanishing from accounts outright, in{" "}
            <a
              className="text-accent-dark underline"
        ...
        <p>
          ...
          settings. You get a limited number, Anthropic doesn&rsquo;t publish
          how many, and once they are redeemed or expired you cannot send more.
        </p>
        <p>
        ...
        <h2 id="faq">Claude guest pass questions</h2>
        <dl>
          {GUEST_PASS_FAQS.map(({ q, a }) => (
            <div key={q}>
        ...
        <div className="mt-10 rounded-2xl border border-line bg-surface px-6 py-6">
          <h2 className="!mt-0">Get a pass</h2>
          <p className="!mt-1">
            Subscribers list spare passes here so they don&rsquo;t expire
            unused. Unlock one, redeem it on claude.ai, and tell us whether it
            worked.
          </p>
          <Link
